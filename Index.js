...
var Cardrequest1 = parseInt( prompt("Ask for a number card"));
alert (Cardrequest1);

var Cardrequest2= parseInt( prompt("Ask for a number card"));
alert (Cardrequest2);

var Cardrequest3= parseInt( prompt("Ask for a number card"));
alert (Cardrequest3);

alert (Cardrequest1 + Cardrequest2 + Cardrequest3);
